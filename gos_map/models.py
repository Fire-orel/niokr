...
class Publications(models.Model):
    ...
    full_name_author = models.CharField(max_length=100,verbose_name="ФИО автора",blank=True)
    ...
    volume_publication=models.IntegerField(verbose_name="Объем публикации (п.л.)",blank=True,null=True)
